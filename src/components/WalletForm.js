...
import { getApi, getCurrency, getEdit } from '../redux/actions';
...
const mapDispatchToProps = (dispatch) => ({
  apiFetch: () => dispatch(getApi()),
  currencyFetch: (state, id) => dispatch(getCurrency(state, id)),
  sendingEdit: (newExpensesArray) => dispatch(getEdit(newExpensesArray)),
});
